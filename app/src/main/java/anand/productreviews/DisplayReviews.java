...
//        no_of_rev=ch.selection;
        ...
        try {
            ...
            HttpGet httpget = new HttpGet("http://reviewrating.esy.es/getproductreviews.php?prod=" + prod_choice);
            ...
            String pros=sb.toString().split("\\|")[0].trim();
            String cons=sb.toString().split("\\|")[1].trim();
            String prosarr[]=pros.split(",");
            ...
            TextView consv=(TextView)findViewById(R.id.cons);
            consv.setText(consfull);
